...
public class RentabilidadRestauranteMDB implements MessageListener, ExceptionListener
{
	...
	public RentabilidadRestauranteMDB(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException
	{
